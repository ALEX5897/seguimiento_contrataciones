...
- `infra/systemd/seguimiento-backend.production.service`
...
### systemd
Archivo: `infra/systemd/seguimiento-backend.production.service`
- Validar `WorkingDirectory=/opt/seguimiento_contrataciones/backend`
- Validar ruta de npm en `ExecStart=/usr/bin/npm start`
- Verificar `EnvironmentFile=/opt/seguimiento_contrataciones/backend/.env.production`
...
sudo cp /opt/seguimiento_contrataciones/infra/systemd/seguimiento-backend.production.service /etc/systemd/system/seguimiento-backend.service
